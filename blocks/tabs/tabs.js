...
var length = document.querySelector('.tabs.block').children.length;
  for (let i=0; i<length-2;i++){
  var table =document.querySelector('.tabs.block').children[1];
  var content =document.querySelector('.tabcontent-container').children[i];
